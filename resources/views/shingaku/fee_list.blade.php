...
@section('content')
        <div class="row">
            ...
            <div class="col-md-2">
                <a class="btn btn-danger btn-block" href="{{route('shingaku.feelist.export.pdf')}}" role="button">PDF出力</a>  
            </div>
            <div class="col-md-2">
                <a class="btn btn-success  btn-block" href="{{route('shingaku.feelist.export.excel')}}" role="button">Excel出力</a>
            </div>
        </div>
